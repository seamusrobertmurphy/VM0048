...
The following documents examples of *Import AOI & visualize:*
...
#bbox_country_1 = sf::st_as_sf(bbox_country_1)
...
```{r, message=F, warning=F, error=F, comment=NA, cache=T, fig.show='hold', out.width="50%", eval=F, echo=F}
...
```{r, message=F, warning=F, error=F, comment=NA, fig.show='hold', out.width="33%", eval=F}
# import
...
```{r, message=F, warning=F, error=F, comment=NA, cache=T, eval=F}
# extract signatures
...
+--------+--------------+--------------+--------------+--------------+--------------+--------------+
|        | Va riables   | A ccuracy    | Kappa        | Acc uracySD  | KappaSD      | S elected    |
|        |              |              |              |              |              |              |
...
```{r, message=F, error=F, cache=T, fig.show='hold', out.width="33%", eval=F}
counties = sf::st_read("./data/covariates/places_poly_county.shp")
